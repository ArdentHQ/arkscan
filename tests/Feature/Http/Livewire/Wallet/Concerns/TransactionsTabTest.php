...
it('should show a locked amount for a validator registration', function () {
    ...
    $hasMatch = (bool) preg_match('/-\s+250\.00/', $response->html());
...
it('should show an unlocked amount for a validator resignation', function () {
    ...
    $hasNegativeMatch = (bool) preg_match('/-\s+250\.00/', $response->html());
    $hasPositiveMatch = (bool) preg_match('/\+\s+250\.00/', $response->html());
