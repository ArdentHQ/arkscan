...
export default function MobileTableRow({
    ...
    return (
        ...
        >
            <div
                className={classNames({
                    "bg-theme-secondary-100 dark:bg-theme-dark-950 flex items-center justify-between rounded-t px-4 py-3 font-semibold": true,
            ...
            {children && (
                <div
                    className={classNames({
                        "flex flex-col space-y-4 px-4 pt-3 pb-4 sm:flex-1 sm:flex-row sm:justify-between sm:space-y-0": true,
