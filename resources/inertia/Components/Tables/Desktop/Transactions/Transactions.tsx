...
export function TransactionsListLoadingState({
    ...
    const columns: ILoadingTableColumn[] = [
        ...
        },
        {
            ...
            className: "text-left",
            render: () => (
                <div className="md-lg:flex-row md-lg:items-center md-lg:space-x-9 md-lg:space-y-0 flex flex-col space-y-2 text-sm font-semibold sm:space-y-1 md:space-y-2">
