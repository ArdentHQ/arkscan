...
function TableHeader({ breakpoint = "sm", resultCount, resultSuffix, children }: { breakpoint: "sm" | "md" | "none"; resultCount: number; resultSuffix?: string; children?: React.ReactNode }) {
    ...
    return (
        <div className={classNames({
            "flex pt-1 md:px-6 md:rounded-t-xl md:border md:border-b-0 md:border-theme-secondary-300 md:dark:border-theme-dark-700": true,
            ...
            <div className="font-semibold dark:text-theme-dark-200">
                <span className="hidden sm:inline">
                    {t('pagination.showing_x_results', {count: resultCount.toLocaleString('us', {maximumFractionDigits: 0})})}
                </span>

                <span className="sm:hidden">
                    {t('pagination.x_results', {count: resultCount.toLocaleString('us', {maximumFractionDigits: 0})})}
                </span>
