...
export default function Wrapper({ tabs, ariaLabel }: { tabs: ITab[]; ariaLabel?: string }) {
    ...
    return (
        <div className="relative px-0 sm:mb-3 sm:px-6 md:mx-auto md:max-w-7xl md:px-10">
            ...
            <div
                ref={containerRef}
                className="no-scrollbar bg-theme-secondary-200 dark:bg-theme-dark-950 mb-6 w-screen overflow-scroll px-6 py-2 sm:mb-4 sm:w-auto sm:bg-transparent! sm:px-0 sm:py-0 md:mb-0"
            >
