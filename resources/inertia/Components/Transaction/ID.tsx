        ...
        <div className="flex flex-col md:space-y-1 xl:space-y-0">
            <div
                className={classNames({
                    "leading-4.25": true,
                    "flex space-x-2 box-border h-[21px] items-center bg-theme-danger-50 dark:bg-transparent border border-transparent dark:border-theme-failed-state-bg px-1.5 rounded":
                ...
                <a
                    ...
                    className={classNames({
                        "mx-auto text-sm font-semibold whitespace-nowrap link leading-4.25":
                            true,
                        "!text-theme-danger-700 dark:!text-theme-failed-state-text":
                            transaction.hasFailedStatus,
                    })}
                >
