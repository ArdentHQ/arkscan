        ...
        <div className="flex flex-col px-6 pb-6 md:mx-auto md:max-w-7xl md:px-10">
            <div
                className={classNames({
                    "flex flex-col space-y-4 overflow-hidden font-semibold sm:flex-row sm:items-end sm:justify-between sm:space-y-0":
                        true,
                    "sm:border-theme-secondary-300 sm:dark:border-theme-dark-700 sm:items-center! sm:rounded-lg sm:border":
                        breakpoint === "sm",
                    "md:border-theme-secondary-300 md:dark:border-theme-dark-700 md:items-center md:rounded-lg md:border":
                        breakpoint === "md",
                })}
            >
                <div
                ...
                >
                    <div
                        className={classNames({
                            "dark:text-theme-dark-200 text-sm leading-4.25! whitespace-nowrap": true,
                    ...
                    <div
                        className={classNames({
                            "text-theme-secondary-900 dark:text-theme-dark-50 min-w-0 leading-5": true,
