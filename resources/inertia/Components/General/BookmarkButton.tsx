        ...
        >
            <button
                ...
                className={classNames(
                    ...
                    isBookmarked
                        ? "border-theme-primary-400 bg-theme-primary-100 hover:border-theme-primary-700 hover:bg-theme-primary-700 dim:border-theme-dark-600 dim:bg-theme-dark-800 dark:border-theme-dark-blue-400 dark:bg-theme-dark-800 dark:hover:border-theme-primary-700 dark:hover:bg-theme-primary-700"
