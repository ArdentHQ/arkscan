    ...
    return (
        <div
            className={classNames([
                ...
                "bg-gradient-to-r from-theme-primary-100 to-theme-primary-200 dark:from-theme-dark-700 dark:to-theme-dark-700",
            ])}
        >
            <div
            ...
            >
                ...
                <div className="relative flex h-30 w-full overflow-hidden md:hidden">
                    <div className="absolute left-1/2 top-1/2 w-[530px] -translate-x-1/2 -translate-y-1/2 sm:w-[690px] md:w-[463px]">
                        <img src={headerBgImage} className="w-full dark:hidden" />
                        <img src={headerBgImageDark} className="hidden w-full dim:hidden dark:block" />
                        <img src={headerBgImageDim} className="hidden w-full dim:block" />
                    </div>
                </div>
