    ...
    return (
        <HeaderItem title={label}>
            <div className="flex flex-grow flex-col justify-between space-y-2">
                <span className="flex divide-x divide-theme-secondary-300 whitespace-nowrap text-sm font-semibold !leading-4.25 text-theme-secondary-900 dark:divide-theme-dark-700 dark:text-theme-dark-50 md:text-base md:!leading-5">
                    <span>{value}</span>
