    ...
    return (
        <HeaderItem title={label}>
            <div className="flex flex-grow flex-col justify-between space-y-2">
                <span className="flex whitespace-nowrap text-sm font-semibold !leading-4.25 text-theme-secondary-900 divide-x divide-theme-secondary-300 dark:text-theme-dark-50 dark:divide-theme-dark-700 md:!leading-5 md:text-base">
                    <span>{value}</span>
