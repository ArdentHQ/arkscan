    ...
    return (
        <div className="lg:hidden">
            <Select value={selected} onValueChange={(value) => onSelect(value as StatisticsPeriod)}>
                <Select.Trigger className="transition-default h-10 w-full !px-3 !py-2 text-left text-sm font-semibold dark:border-theme-dark-700 dark:bg-theme-dark-900 md:inline-block">
