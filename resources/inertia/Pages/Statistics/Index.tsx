    ...
    return (
        <Layout>
            ...
            <div className="px-6 pb-3 md:mx-auto md:max-w-7xl md:px-10">
                <div className="dim:bg-theme-dim-800 dim:text-theme-dim-500 bg-theme-primary-100 dark:bg-theme-dark-800 flex items-start space-x-2 rounded px-6 py-6 text-sm leading-[17px] md:rounded-xl md:py-3">
                    <CircleInfoIcon className="dim:text-theme-dim-600 text-theme-primary-700 dark:text-theme-dark-blue-400 mt-0.5 h-4 w-4 shrink-0" />

                    <span className="text-theme-primary-900 dark:text-theme-dark-50 leading-[21px] md:leading-[17px]">
            ...
            <div>
                <div className="border-theme-secondary-200 dark:border-theme-dark-950 space-y-6 border-t-4 px-6 py-6 md:mx-auto md:max-w-7xl md:border-0 md:px-10">
