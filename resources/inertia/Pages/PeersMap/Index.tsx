            ...
            <div className="px-6 md:mx-auto md:max-w-7xl md:px-10">
                <div className="rounded border border-theme-secondary-300 p-6 dark:border-theme-dark-700 md:rounded-xl">
                    <div className="mb-4 flex items-center">
                        <span className="inline-flex items-center gap-2 rounded-full border-2 border-white bg-gray-200 px-3 py-1.5 text-sm dark:border-theme-dark-900 dark:bg-theme-dark-950">
                            <span className="h-2.5 w-2.5 rounded-full bg-blue-600 dark:bg-theme-dark-blue-600" />

                            <span className="text-gray-700 dark:text-theme-dark-200">
                                {t("pages.peers-map.active_peers")}
                            </span>

                            <span className="font-semibold text-gray-900 dark:text-theme-dark-50">
                                {peers.length}
                            </span>
                        </span>
                    </div>
