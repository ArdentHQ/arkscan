    ...
    return (
        <Layout className="mx:px-10 px-6 py-8">
            <div className="text-center">
                ...
                {type === "wallet" ? (
                    <>
                        <div className="text-theme-secondary-900 dark:text-theme-dark-200 mt-8 space-x-1 text-center text-lg font-semibold">
                            <span>{t("errors.address")}</span>
                            <span className="bg-theme-warning-50 dark:bg-theme-dark-900 hidden sm:inline dark:text-white">
                                {id}
                            </span>
                            <TruncateMiddle
                                length={17}
                                className="bg-theme-warning-50 dark:bg-theme-dark-900 sm:hidden sm:inline dark:text-white"
                            >
                        ...
                        <div className="text-theme-secondary-900 dark:text-theme-dark-200 mt-3 text-center leading-7">
