...
>
    ...
    <div class="flex space-x-3">
        ...
        <div class="relative">
            <form x-cloak x-show="search" name="searchForm" type="get" class="flex overflow-hidden absolute left-0 z-10 px-2 w-full h-full rounded bg-theme-primary-100 pagination-form-desktop dark:bg-theme-dark-800">
                <input
                    x-ref="search"
                    x-model.number="page"
                    type="number"
