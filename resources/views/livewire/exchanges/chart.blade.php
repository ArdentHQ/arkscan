        ...
        <div class="flex flex-col space-y-3 sm:flex-row sm:justify-between sm:space-y-0">
            <div class="inline-flex items-center space-x-2 sm:space-x-3 md:items-end">
                ...
                <span @class([
                    ...
                    'border border-transparent bg-theme-success-100 dark:bg-transparent dark:border-theme-success-700 text-theme-success-600 dark:text-theme-success-500' => $mainValueVariation === 'green',
                    'border border-transparent bg-theme-danger-100 dark:bg-transparent dark:border-theme-danger-400 text-theme-danger-400 dark:text-theme-danger-300' => $mainValueVariation === 'red',
                ])>
                    <span>
