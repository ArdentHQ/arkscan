<div class="flex flex-col px-8 m-auto space-y-5 md:px-10 xl:flex-row xl:space-y-0 xl:space-x-5 xl:max-w-7xl">
    <div class="flex min-w-0 md:space-x-4 xl:w-164">
        <div class="flex flex-col flex-1 justify-between space-y-5 w-full font-semibold sm:flex-row sm:space-y-0 sm:space-x-4 sm:rounded-xl sm:bg-theme-hint-800">
            <div class="flex flex-1 py-4 px-8 min-w-0 rounded-xl sm:pr-0 sm:bg-transparent sm:rounded-none md:space-x-4 bg-theme-hint-800">
                <x-ark-icon
            ...
            <div class="flex justify-between py-4 px-8 space-x-6 rounded-xl divide-x sm:pl-0 sm:bg-transparent sm:rounded-none divide-theme-hint-700 bg-theme-hint-800 w-62">
                <div class="flex flex-col justify-between space-y-2 whitespace-nowrap sm:text-right">
                    <span class="text-sm leading-none text-theme-hint-300">
