...
>
    <div @class([
        'flex rounded items-center md:bg-theme-secondary-200 md:dark:bg-theme-dark-800 md:border border-theme-secondary-300 dark:border-transparent justify-between',
        'md:text-theme-secondary-500 md:dark:text-theme-dark-700 cursor-not-allowed select-none' => $isDisabled,
        'md:text-theme-secondary-700 md:dark:text-theme-dark-200 cursor-default' => ! $isDisabled,
    ])>
            ...
            >
                <div
                    @class([
                        ...
                        'hover:text-theme-secondary-900 hover:dark:text-theme-dark-200 md:dark:text-theme-dark-200' => ! $isDisabled,
                    ])
                    @if ($isDisabled)
                        disabled
                    @endif
                >
                    <div @class([
                        ...
                        'bg-theme-secondary-300 dark:bg-theme-dark-700' => $isDisabled,
