<div class="w-full sm:w-auto">
    ...
    @if($this->modalShown)
        <x-ark-modal
            ...
            wire-close="cancel"
            close-button-class="absolute top-0 right-0 p-0 mt-0 mr-0 w-8 h-8 rounded-none sm:mt-6 sm:mr-6 sm:rounded button button-secondary text-theme-secondary-900 hover:dark:text-theme-dark-50 hover:dark:bg-theme-dark-blue-600 dim:bg-transparent dim:shadow-none"
