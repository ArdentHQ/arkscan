<div class="flex items-center justify-between pb-4 space-x-4">
    <div class="flex flex-col flex-1 min-w-0 min-h-0 space-y-2">
        ...
        @if((string) $slot === "")
            <span class="font-semibold break-all text-theme-secondary-500 dark:text-theme-secondary-200">@lang('generic.not_specified')</span>
        @else
            <span class="font-semibold break-all text-theme-secondary-700 dark:text-theme-secondary-200">{{ $slot }}</span>
        @endif
    </div>
