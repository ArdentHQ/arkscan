<div class="flex pt-8 space-y-6 content-container">
    <div class="flex flex-row justify-center p-8 w-full rounded-lg sm:justify-between h-30 lg:h-32 bg-theme-primary-600">
        ...
        <div class="hidden flex-row items-center lg:flex">
            <div class="inline-block relative text-white">
                <x-ark-icon name="app-marketsquare" class="ml-2 h-6 text-white md:h-8 lg:h-12 lg:ml-0" />
            </div>
