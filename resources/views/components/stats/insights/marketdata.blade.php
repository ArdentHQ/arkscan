                    ...
                    <div class="flex flex-col justify-between pt-3 space-y-3 w-full sm:flex-row sm:space-y-0">
                        <div class="flex flex-col space-y-2">
                            ...
                            <span class="text-theme-secondary-900 dark:text-theme-dark-50">
                                @if($item === 'daily')
                                    {{ ExplorerNumberFormatter::currencyWithDecimals($prices[$item.'_low'], 'USD', 2) }}
                                    -
                                    {{ ExplorerNumberFormatter::currencyWithDecimals($prices[$item.'_high'], 'USD', 2) }}
                                @else
                                    {{ ExplorerNumberFormatter::currencyWithDecimals($prices[$item], 'USD', 2) }}
                                @endif
                            </span>
                        </div>
                        ...
                        <div class="flex flex-col space-y-2 w-[130px]">
                            @if($item === 'daily')
                                ...
                                <span class="text-theme-secondary-900 dark:text-theme-dark-50">
                                    {{ ExplorerNumberFormatter::currencyWithDecimals($prices['52w_low'], 'USD', 2) }}
                                    -
                                    {{ ExplorerNumberFormatter::currencyWithDecimals($prices['52w_high'], 'USD', 2) }}
                                </span>
                ...
                <div class="flex md:hidden">
                    <div class="flex flex-col justify-between pt-3 space-y-3 w-full sm:flex-row sm:space-y-0">
                        <div class="flex flex-col space-y-2">
                            <span>@lang('pages.statistics.insights.market_data.header.'.$item)</span>
                            <span class="text-theme-secondary-900 dark:text-theme-dark-50">
                                {{ ExplorerNumberFormatter::currencyForViews($volumes[$item], 'USD') }}
                            </span>
                        </div>
                ...
                <div class="flex md:hidden">
                    <div class="flex flex-col justify-between pt-3 space-y-3 w-full sm:flex-row sm:space-y-0">
                        <div class="flex flex-col space-y-2">
                            <span>@lang('pages.statistics.insights.market_data.header.'.$item)</span>
                            <span class="text-theme-secondary-900 dark:text-theme-dark-50">
                                {{ ExplorerNumberFormatter::currencyForViews($caps[$item], 'USD') }}
                            </span>
                        </div>
