<div class="flex space-x-4 w-full md:flex-col md:space-y-4 md:space-x-0 xl:flex-row xl:space-y-0 xl:space-x-4 h-18">
    <div class="flex flex-row py-3 px-6 bg-white rounded-xl dark:bg-theme-dark-900">
        <div class="flex mr-2 w-full lg:w-1/2 xl:w-full">
            <div class="flex items-center pr-6 space-x-4 border-r border-theme-secondary-300 dark:border-theme-dark-800">
            ...
            <div class="flex items-center pr-6 ml-6 space-x-4 border-r border-theme-secondary-300 dark:border-theme-dark-800">
                <div class="h-11 rounded-xl border-none loading-state circled-icon"></div>
    ...
    <div class="flex flex-row space-x-4 w-full">
        <div class="flex flex-grow py-3 px-6 bg-white rounded-xl dark:bg-theme-dark-900">
        ...
        <div class="flex flex-grow py-3 px-6 bg-white rounded-xl dark:bg-theme-dark-900">
            <x-validators.skeletons.data-boxes-next-validator />
        </div>
    </div>
</div>
