...
<div x-data="{
    ...
    validator: '{{ $model->address() }}',
}">
    @if ($model->isResigned() && ! $withoutResignedVote)
        <div
            x-show="votingForAddress !== validator"
            data-tippy-content="@lang('pages.wallet.validator.resigned_vote_tooltip')"
        >
            <button
                type="button"
    ...
    >
        ...
        >
            <x-slot
                ...
                ::class="{
                    'text-theme-primary-600 hover:text-theme-primary-700 dark:text-theme-dark-blue-400 dark:hover:text-theme-dark-blue-500 dim:text-theme-dim-blue-600 dim:hover:text-theme-dim-blue-700': votingForAddress !== validator,
                    'text-theme-danger-400 hover:text-theme-danger-500': votingForAddress === validator,
                }"
            >
                <div x-show="votingForAddress !== validator">
                    {{ $voteText }}
                </div>
