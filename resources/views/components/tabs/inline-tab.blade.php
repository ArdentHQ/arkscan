...
<button
    type="button"
    class="flex relative items-center space-x-6 cursor-pointer pr-6 last:pr-4 first:pl-4 transition-default dark:hover:text-theme-secondary-200 hover:text-theme-secondary-900"
    @click="select('{{ $name }}')"
