...
<span class="flex py-1 px-1.5 font-semibold whitespace-nowrap rounded border-2 fiat-tooltip-sent text-theme-hint-600 border-theme-hint-100 dark:text-theme-hint-400 dark:border-theme-hint-400">
