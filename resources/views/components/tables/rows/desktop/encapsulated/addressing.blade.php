...
<div {{ $attributes->class('flex items-center space-x-2 text-sm font-semibold') }}>
    <div @class([
        ...
        'text-theme-secondary-700 bg-theme-secondary-200 border-theme-secondary-200 dark:bg-transparent dark:border-theme-dark-700 dark:text-theme-dark-200' => $isSentToSelf,
