...
<x-tables.rows.desktop.encapsulated.cell class="text-theme-secondary-900 dark:text-theme-secondary-200">
    @if ($model)
        ...
        @unless($withoutBreakdown)
            <div class="hidden mt-1 space-x-2 text-xs divide-x sm:flex lg:hidden divide divide-theme-secondary-300 text-theme-secondary-700 dark:text-theme-dark-200 dark:divide-theme-dark-700 leading-3.75">
