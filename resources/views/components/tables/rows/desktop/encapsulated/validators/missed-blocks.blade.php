...
<x-general.badge
    ...
    :colors="Arr::toCssClasses([
        ...
        'bg-theme-orange-light border-theme-orange-light text-theme-orange-dark dark:!border-theme-warning-600 dark:text-theme-warning-400 dim:text-theme-warning-400' => $state === 'warning',
        'bg-theme-danger-100 border-theme-danger-100 text-theme-danger-700 dark:border-theme-failed-state-bg dark:text-theme-failed-state-text dim:border-theme-failed-state-bg dim:text-theme-failed-state-text' => $state === 'danger',
