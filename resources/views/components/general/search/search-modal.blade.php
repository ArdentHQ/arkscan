<div>
    @if($modalShown)
        ...
        >
            ...
            <div class="flex overflow-auto relative flex-col p-6 my-6 mx-4 bg-white rounded-xl dark:bg-theme-secondary-900">

                <x-general.search.search-input />

                <div class="flex overflow-auto flex-col space-y-4 text-sm font-semibold whitespace-nowrap divide-y divide-dashed divide-theme-secondary-300 custom-scroll">
                    @if ($hasResults && $results !== null)
                        ...
                        @endforeach
                    @else
                        <div class="mt-4 text-center whitespace-normal">
