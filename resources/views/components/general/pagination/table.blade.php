...
@if ($results->total() >= config('arkscan.pagination.per_page'))
    <div {{ $attributes->class('-mx-6 px-6 border-t border-theme-secondary-300 dark:border-theme-dark-700 md:border-t-0 md:border rounded-b-xl mt-4 md:mt-0 pt-4 md:pb-4 md:mx-0 flex flex-col items-center space-y-6 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between') }}>
