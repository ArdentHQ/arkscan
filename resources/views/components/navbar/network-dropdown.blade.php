...
>
    ...
    <div
        ...
        x-transition
        x-cloak
        class="flex overflow-hidden absolute right-0 top-full z-10 flex-col py-3 whitespace-nowrap bg-white rounded-xl md:right-0 shadow-toggle-dropdown dark:bg-theme-secondary-800"
    >
        <a
            @click="isOpen = false"
