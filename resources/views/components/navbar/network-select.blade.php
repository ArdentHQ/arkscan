...
<a href="{{ $url }}" {{ $attributes->class([
    ...
    'border-theme-success-100 dark:border-theme-secondary-800 hover:border-theme-success-600 dark:hover:border-theme-success-600 hover:bg-theme-success-50 dark:hover:bg-theme-success-900 bg-white dark:bg-theme-secondary-900 transition' => ! $active,
]) }}>
