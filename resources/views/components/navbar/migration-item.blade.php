...
>
    <span @class([
        ...
        <span class="flex text-transparent bg-clip-text bg-gradient-to-r animate-move-bg-start-right from-theme-danger-400 to-theme-danger-400 bg-500 via-theme-hint-600 dark:to-theme-danger-400 dark:via-theme-hint-400">
            <span>
        ...
        <div class="flex absolute -right-3 h-6">
            <div
                class="inline-block bg-gradient-to-r animate-move-bg from-theme-danger-400 to-theme-danger-400 bg-500 via-theme-hint-600 dark:to-theme-danger-400 dark:via-theme-hint-400"
