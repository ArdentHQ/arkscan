...
<a
    ...
    @class([
        'ml-6 border-l border-theme-secondary-300 dark:border-theme-dark-500 px-6 py-3 inline-flex font-semibold leading-5 group focus:outline-none transition-default w-full h-full relative dark:hover:bg-theme-dark-900 hover:bg-theme-secondary-200',
