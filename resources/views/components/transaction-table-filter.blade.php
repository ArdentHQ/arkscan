...
<x-rich-select
    ...
    button-class="flex relative items-center p-3 w-full font-semibold text-left {{ $buttonClass }} focus:outline-none text-theme-secondary-900 dark:text-theme-secondary-200"
    icon-class="hidden"
