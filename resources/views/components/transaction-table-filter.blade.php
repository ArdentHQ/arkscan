<div x-data="{
    ...
    <x-ark-dropdown
        dropdown-classes="left-0 w-64 mt-3 overflow-y-scroll h-128"
        ...
        @slot('button')
            <div class="flex items-center justify-end w-full space-x-2 font-semibold flex-inline text-theme-secondary-700">
                ...
                <span
                    ...
                    class="flex items-center justify-center w-4 h-4 transition duration-150 ease-in-out rounded-full bg-theme-primary-100 text-theme-primary-600"
                >
