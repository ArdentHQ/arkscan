<x-page-headers.header-item
    ...
    class="flex-none -mx-6 mt-8 md:mt-6 -mb-8 rounded-none md:mx-0 md:mb-0 xl:flex-1 bg-theme-primary-100 dim:bg-theme-dark-700 sm:h-[140px] md:h-[150px] md-lg:h-[193px] lg:h-[206px] xl:h-[264px] dark:bg-theme-dark-800"
