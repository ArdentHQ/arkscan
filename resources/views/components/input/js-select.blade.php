...
>
    ...
    <x-general.dropdown.dropdown
        ...
        :init-alpine="false"
        active-button-class="bg-white dark:text-theme-secondary-600 hover:text-theme-secondary-900 hover:bg-theme-secondary-200 dark:bg-theme-secondary-900 dark:hover:bg-theme-secondary-800"
    >
        <x-slot
            name="button"
