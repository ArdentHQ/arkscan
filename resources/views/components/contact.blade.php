    ...
    <div class="flex flex-col pb-8 mx-auto max-w-7xl md:px-10 lg:flex-row dark:text-theme-dark-200">
        <div class="flex flex-col flex-1 justify-between rounded-xl md:border lg:mr-1.5 lg:w-1/2 border-theme-secondary-300 dark:border-theme-dark-700">
            ...
            @if (count($contactNetworks) > 0)
                <div class="md:py-4 py-6 px-6 space-y-3 rounded-b-xl md:flex md:justify-between md:items-center md:space-y-0 text-theme-secondary-900 md:bg-theme-secondary-100 dark:text-theme-dark-200 dark:md:bg-theme-dark-950">
        ...
        <div class="flex flex-col flex-1 p-6 rounded-xl md:mt-3 md:border lg:mt-0 lg:ml-1.5 border-theme-secondary-300 dark:border-theme-dark-700 leading-5.25">
            ...
            <div class="flex justify-between items-center px-4 mt-4 md:mt-6 space-x-3 rounded border md:h-14 h-[45px] border-theme-secondary-300 bg-theme-secondary-100 dark:border-theme-dark-700 dark:bg-theme-dark-950">
            ...
            @if ($emailHint)
                <p class="mt-2 text-xs font-semibold text-theme-secondary-500 dark:text-theme-dark-500 leading-3.75">
                    {{ $emailHint }}
                </p>
            @endif
        </div>
