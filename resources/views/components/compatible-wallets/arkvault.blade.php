<div class="flex-col rounded-xl md:mt-6 md:border border-theme-secondary-300 dark:border-theme-secondary-800">
    <x-compatible-wallets.disclaimer
        class="xl:hidden md:px-8 md:pt-6 pb-4 inline-flex w-full"
        inner-class="w-full"
    />

    <div class="flex flex-col w-full min-[960px]:flex-row">
        <div class="flex flex-col flex-1 justify-center pb-8 xl:py-8 md:px-8">
            ...
            <div class="flex flex-col justify-between py-3 px-3 rounded-xl sm:flex-row md:pl-6 bg-theme-primary-50 dark:bg-theme-dark-blue-800 mt-6">
