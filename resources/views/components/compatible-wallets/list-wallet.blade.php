<div class="flex flex-col justify-between items-center py-6 px-6 mt-6 w-full text-center rounded-xl sm:flex-row sm:py-2 list-wallet-gradient sm:text-start dark:bg-theme-secondary-800">
