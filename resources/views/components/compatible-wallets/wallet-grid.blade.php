<div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 md:mt-6 xl:grid-cols-4 md-lg:grid-cols-4">
            ...
            <div class="mx-6 mt-3 mb-6">
                <span class="inline font-semibold break-words transition text-theme-primary-600 dark:text-theme-dark-blue-400 dark:group-hover:text-theme-dark-blue-500 group-hover:text-theme-primary-700">
                    ...
                    <x-ark-icon
                        ...
                        size="xs"
                        class="inline relative -top-1 flex-shrink-0 mt-1 ml-0.5 text-theme-secondary-500 dark:text-theme-dark-500"
                    />
                </span>
            </div>
        </a>
