        ...
        <x-ark-container>
            ...
            <div class="flex flex-col mt-6 w-full rounded-xl border min-[960px]:flex-row border-theme-secondary-300 dark:border-theme-secondary-800">
                <div class="flex flex-col flex-1 justify-between py-8 px-8 space-y-6">
                    ...
                    <div class="">
                        <h2 class="text-2xl font-semibold text-theme-secondary-900">@lang('general.arkvault') <span class="text-theme-secondary-500 dark:text-theme-secondary-200">(@lang('pages.compatible-wallets.arkvault.web_wallet'))</span></h2>
                        <p class="mt-2 leading-7 dark:text-theme-secondary-400">@lang('pages.compatible-wallets.arkvault.description')</p>
                    </div>
                    <div class="flex flex-col justify-between py-3 pr-3 pl-6 rounded-xl sm:flex-row bg-theme-primary-50">
                        <div class="flex flex-1 items-center py-1 bg-no-repeat bg-right sm:bg-[url('/images/wallets/arrows.svg')] min-[960px]:bg-none lg:bg-[url('/images/wallets/arrows.svg')] mr-2">
                            ...
                            <div class="flex flex-col ml-3">
                                <span class="text-lg font-semibold text-theme-secondary-900">@lang('general.arkvault')</span>
                                <span class="text-sm font-semibold text-theme-secondary-700">@lang('pages.compatible-wallets.arkvault.subtitle')</span>
                            </div>
                        </div>
