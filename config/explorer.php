...
return [
    ...
    'networks' => [
        'production' => [
            ...
            'host'             => env('EXPLORER_NETWORK_HOST', 'https://wallets.ark.io/api'),
        ...
        'development' => [
            ...
            'host'             => env('EXPLORER_NETWORK_HOST', 'https://dwallets.ark.io/api'),
            'usesMarketsquare' => env('EXPLORER_NETWORK_USES_MARKETSQUARE', false),
    ...
    'nodejs'  => env('EXPLORER_NODEJS', '/usr/local/bin/node'),
