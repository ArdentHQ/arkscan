...
final class DelegateEntityRegistrationScope implements Scope
{
    public function apply(Builder $builder, Model $model)
    {
        ...
        $builder->where('asset->type', MagistrateTransactionEntityTypeEnum::DELEGATE);
        $builder->where('asset->action', MagistrateTransactionEntityActionEnum::REGISTER);
    }
}
